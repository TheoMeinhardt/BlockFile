<template>
  ...
  >
    ...
    <router-link to="/login" class="text-center mt-12"
      ><a class="px-10 py-3 bg-blue-500 hover:bg-blue-400 rounded-md text-center text-white">Login</a></router-link
    >
    <p class="my-3 text-center mt-10">Dont have an account?</p>
    <router-link to="/register" class="text-center mt-12"
      ><a class="px-10 py-3 shadow-md rounded-md hover:shadow-lg text-center">Register</a></router-link
    >
  </div>
</template>
